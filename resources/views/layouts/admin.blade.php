...
<head>
  ...
  <!-- Fonts -->
  <script src="https://kit.fontawesome.com/73d927d61d.js" crossorigin="anonymous"></script>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Jenis Soal -->
      <li class="nav-item {{ Nav::isRoute('jenis.index') }}">
        <a class="nav-link" href="{{ route('jenis.index') }}">
          <i class="fas fa-list"></i>
          <span>{{ __(' Jenis Soal') }}</span>
        </a>
      </li>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">{{ __('Apakah Anda Ingin Keluar?') }}</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">Pilih "Keluar" untuk mengakhiri aktifitas anda.</div>
